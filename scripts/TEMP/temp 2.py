...
trainDicts = torch.load("sharkTrainDicts.pt")
valDicts = torch.load("sharkValDicts.pt")
...
torch.save(trainDicts,"sharkTrainDicts_modified.pt")
torch.save(valDicts,"sharkValDicts_modified.pt")